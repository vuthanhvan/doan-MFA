...
watch(router.currentRoute, () => path.value = router.currentRoute.value.path);
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                        ...
                        <RouterLink to="/"
                            :class="[path == '/' ? 'border-indigo-500' : 'border-transparent', 'text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium']">
                            Home </RouterLink>
                        <RouterLink to="/login"
                            :class="[path == '/login' ? 'border-indigo-500' : 'border-transparent', 'text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium']">
                            Login </RouterLink>
                        <RouterLink to="/register"
                            :class="[path == '/register' ? 'border-indigo-500' : 'border-transparent', 'text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium']">
                            Register </RouterLink>
                    </div>
                </div>
